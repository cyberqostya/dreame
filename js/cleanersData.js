const cleaners = [
  {
    ...
    advantages: [
      ...
      { title: 'Тип питания', text: 'аккумулятор' },
      { title: 'Тип уборки', text: 'сухая' },
      { title: 'Время зарядки', text: '240 мин' },
      { title: 'Время работы от одного заряда', text: '90 мин' },
      { title: 'Объем контейнера для пыли ', text: '500 мл' },
      { title: 'Уровень шума', text: '83 дБ' },
...

  {
    ...
    name: 'T10',
    images: [
      { link: './img/wireless/T10/1.png', objectFit: 'contain' },
      { link: './img/wireless/T10/2.png', objectFit: 'contain' },
      { link: './img/wireless/T10/3.jpg', objectFit: 'cover' },
      { link: './img/wireless/T10/4.png', objectFit: 'contain' },
    ...
    advantages: [
      ...
      { title: 'Время работы от одного заряда', text: '60 мин' },
      { title: 'Объем контейнера для пыли ', text: '600 мл' },
      { title: 'Уровень шума', text: '83 дБ' },
      { title: 'Вес', text: '1,65 кг' },
    ]
  },
...

  {
    ...
    advantages: [
      ...
      { title: 'Время работы от одного заряда ', text: '150 мин' },
      { title: 'Объем контейнера для пыли', text: '400 мл' },
      { title: 'Объем контейнера для воды ', text: '200 мл' },
      { title: 'Мощность всасывания', text: '2500 Па' },
      { title: 'Виртуальная стена', text: 'с помощью приложения' },
      { title: 'Высота преодоливаемых порогов ', text: '15 мм' },
      { title: 'Уровень шума', text: '65 дБ' },
      { title: 'Вес', text: '3 кг' },
...

  {
    ...
    advantages: [
      ...
      { title: 'Время работы от одного заряда ', text: '150 мин' },
      { title: 'Объем контейнера для пыли', text: '570 мл' },
